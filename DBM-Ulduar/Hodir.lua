...
local timerFlashFrCD		= mod:NewCDTimer(60, 61968, nil, nil, nil, 2, nil, DBM_COMMON_L.IMPORTANT_ICON..DBM_COMMON_L.DEADLY_ICON) --|48| REVIEW! Need logs to validate (25 man S2 VOD review) - 48, 48
...
function mod:OnCombatStart(delay)
	...
	timerAchieve:Start()
	timerFlashFrCD:Start(-delay) --|63| REVIEW! Need more logs to validate variance (25 man log review (2022/07/10) || S2 VOD review) - 66.7 || 63, 65
end
