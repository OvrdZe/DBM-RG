...
local timerFlameJetsCooldown	= mod:NewCDTimer(30, 63472, nil, nil, nil, 2, nil, DBM_COMMON_L.IMPORTANT_ICON, true) --|45.1| 10/25 diff. ~3s variance. Transcriptor snippet below. Added "keep" arg
...
function mod:OnCombatStart(delay)
	...
	timerAchieve:Start()
	timerActivateConstruct:Start(-delay, 1) --|15| REVIEW! variance? (10m Frostmourne 2022/07/17 || 25m Lordaeron 2022/10/05 || 25m Lordaeron 2022/10/09) - 15.0 || 15.0 || 15.0
	timerScorchCooldown:Start(16-delay) --|25| (10m Frostmourne 2022/07/17 || 25m Lordaeron 2022/10/05 || 25m Lordaeron 2022/10/09) - 25.0 || 25.0 || 25.0
	timerFlameJetsCooldown:Start(27) --|25-delay| 25 man log review (2022/07/10)
end
...
function mod:SPELL_CAST_START(args)
	if args:IsSpellID(62680, 63472) then		-- Flame Jets
		...
		timerFlameJetsCooldown:Start(self:IsDifficulty("normal10") and 0 or 0) --|41.5 or 45.1| 10/25 different. ~5s variance (25 man log review 2022/07/10 || 10m Frostmourne 2022/07/17 || 25m Lordaeron 2022/10/05 || 25m Lordaeron 2022/10/09) - 45.1, 47.0 || 43.5, 41.5, 45.9, 41.9 || 47.2, 45.8, 47.0 || 48.9, 46.6
	elseif args.spellId == 62488 then		-- Activate Construct
		...
		if self.vb.ConstructCount < 20 then
			timerActivateConstruct:Start(self:IsDifficulty("normal10") and 0 or 0, self.vb.ConstructCount+1) --|43 or 33| 10/25 different. ~6s variance (25 man log review 2022/07/10 || 10m Frostmourne 2022/07/17 || 25m Lordaeron 2022/10/05 || 25m Lordaeron 2022/10/09) - 33.5, 38.5, 37.8 || 43.1, 46.0, 43.0, 46.0, 43.0 || 33.0, 39.1, 38.7, 39.0 || 33.0, 39.0, 36.0, 39.0
		end
	end
end
