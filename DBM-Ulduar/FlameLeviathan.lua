...
local timertFlameVentsCD		= mod:NewCDTimer(20, 62396, nil, nil, nil, 2) --|19.7| ~0.5s variance (S3 FM Log review 2022/07/17 || 25m Lordaeron 2022/10/30) - 0.1, 20.0, 20.0, 20.1, 20.0, 20.3 || 20.3, 19.7, 20.0, 20.1
local timerPursued				= mod:NewTargetTimer(35, 62374, nil, nil, nil, 3) --|30| Variance dependent on whether boss is pulled right after gate opens or not. Corrected using count. S3 FM Log review 2022/07/17 - 0.1, 11.0, 19.0, 30.0, 30.0, 30.0
