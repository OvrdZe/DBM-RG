...
local timerTurret1					= mod:NewTimer(53, "timerTurret1", 48642, nil, nil, 5, DBM_COMMON_L.IMPORTANT_ICON) --|54| 25 man log review (2022/07/10)
local timerTurret2					= mod:NewTimer(73, "timerTurret2", 48642, nil, nil, 5, DBM_COMMON_L.IMPORTANT_ICON) --|76| 25 man log review (2022/07/10)
local timerTurret3					= mod:NewTimer(93, "timerTurret3", 48642, nil, nil, 5, DBM_COMMON_L.IMPORTANT_ICON) --|97| 25 man log review (2022/07/10)
local timerTurret4					= mod:NewTimer(113, "timerTurret4", 48642, nil, nil, 5, DBM_COMMON_L.IMPORTANT_ICON) --|118| 25 man log review (2022/07/10)
...
local timerDeepBreathCooldown		= mod:NewCDTimer(21, 64021, nil, nil, nil, 5) --|20.1| ~3s variance (25 man log review 2022/07/10) - 23.0, 20.1
...
function mod:OnCombatStart(delay)
	...
	if self:IsDifficulty("normal10") then -- REVIEW. No log yet to validate this.
		...
		warnTurretsReadySoon:Schedule(95-delay) --|97|
		warnTurretsReady:Schedule(117-delay) --|118|
