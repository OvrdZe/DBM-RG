...
local timerNatureFury			= mod:NewTargetTimer(10, 63571, nil, nil, nil, 3) --|7.9| ~5s variance (25 man HM log 2022/07/17) - 13.6, 7.9, 8.8, 11.7, 11.7, 12.9, 11.4
...
local timerNatureBombExplosion	= mod:NewCastTimer(11, 64587, 34539, nil, nil, 2) --|10| On explosion, not on summon. Applied a Explosion text. REVIEW! 2s variance from first explosion from the set to the first explosion from the next set (S3 HM log 2022/07/22) - 11, 10.3, 11.9, 11.2, 10.4, 11.3, 10.5
...
local timerGroundTremorCD		= mod:NewCDTimer(26, 62859, nil, nil, nil, 2) --|25.5| ~10s variance (25 man HM log 2022/07/17) - 27.4, 25.8, 25.5, 26.5; 26.8, 26.1, 26.2, 25.7, 27.2
local timerIronRootsCD			= mod:NewCDTimer(14, 62438, nil, nil, nil, 3) --|12.1| ~7s variance (could be 10s) (2022/07/05 log review || 25 man HM log 2022/07/17) - 12, 16 || 15.9, 16.5, 14.8, 18.7, 13.8, 12.8, 13.4, 19.1; 13.2, 17.9, 12.1, 15.7, 15.0, 15.9, 12.3, 15.4
local timerUnstableBeamCD		= mod:NewCDTimer(15, 62865, nil, nil, nil, 2, nil, nil, true) --|15.6| Hard mode Sun Beam. ~5s variance [15-20]. Added "keep" arg (2022/07/05 log review || 25 man HM log 2022/07/17 || 25H Lordaeron 2022/10/30) - 18.7, 16.6 || 15.8, 20.0, 17.3, 18.9, 16.1, 16.6, 15.6 ; 20.4, 17.4, 16.5, 18.3, 16.9, 16.1, 16.3 || 17.6
